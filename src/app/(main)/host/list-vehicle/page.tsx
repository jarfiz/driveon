    ...
    <div className="container mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Images */}
          <div>
            <label className="text-sm font-semibold">Vehicle Photos</label>
            <div className="mt-2 cursor-pointer rounded-lg border-2 border-dashed border-slate-300 p-8 text-center hover:bg-slate-50">
              <p className="text-sm text-slate-600">
                Drag and drop images here or click to upload
              </p>
              <p className="mt-1 text-xs text-slate-500">
                Recommended: 3-6 high-quality images
              </p>
            </div>
          </div>
          ...
          {/* Rules */}
          <div>
            <label className="text-sm font-semibold">Rental Rules</label>
            <div className="mt-3 space-y-2">
              {[
                "Maximum fuel usage per day",
                "Mileage limit",
                "No smoking policy",
                "No pets allowed",
              ].map((rule) => (
          ...
          <div className="flex gap-3">
            <Button className="flex-1">List Vehicle</Button>
